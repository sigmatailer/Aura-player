...
export const MyVibe: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-start bg-transparent px-4 sm:px-6 md:px-8 pt-16 sm:pt-16 md:pt-8 pb-24 relative overflow-y-auto gap-6 select-none scrollbar-hide">
